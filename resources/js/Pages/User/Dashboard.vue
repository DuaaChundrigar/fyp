        ...
        <div class="px-2 mx-auto max-w-7xl sm:px-6 lg:px-8">
            <div class="relative flex items-center justify-between h-16">
                ...
                >
                    ...
                    <div
                        class="m-auto ml-4 font-serif text-4xl font-bold text-gray-700"
                    >
                        <button
                            type="button"
                            class="px-3 py-2 text-sm font-medium text-white bg-gray-700 rounded"
                            id="rfb"
                        >
                        ...
                        <button
                            type="button"
                            class="px-3 py-2 ml-2 text-sm font-medium text-white bg-gray-700 rounded"
                            id="lor"
                        >
                ...
                >
                    <div>
                        <button
                            type="button"
                            class="px-3 py-2 text-sm font-medium text-white bg-gray-700 rounded-md"
                            id="login"
                        >
